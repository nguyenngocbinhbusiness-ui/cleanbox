...
status: draft
supersedes: ./business_analysis_v1.md
superseded_by: null

# VERSION METADATA
change_summary: "Added BR-005 for auto-detecting Downloads and Recycle Bin as default cleanup directories"
change_type: minor
reviewed_by: null
review_date: null
...
| Type | Description |
|------|-------------|
| **In-Scope** | System tray app, auto-start, storage monitoring, notifications, directory cleanup, configuration UI, **auto-detect default directories** |
